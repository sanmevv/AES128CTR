...
c,addr=s1.accept()
def encrypt():
    Input = input( Fore.WHITE +'enter message to alice: ')
...
def decrypt():
    ...
    print(Fore.MAGENTA+'Reply from Alice : ', str(message1, 'utf-8'))
def loop():
    while True:
        encrypt()
        decrypt()
...
print(
    Fore.GREEN + "Hello Bob, this application is using AES-128 bit CTR Mode Algorithm for Encryption and Decryption\n"
